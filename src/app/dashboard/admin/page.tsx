...
export default function AdminDashboard() {
  ...
  // Fetch real data from MongoDB - useCallback to prevent recreation
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#1E293B] p-4">
        <div className="max-w-md w-full bg-[#1E293B]/50 border border-[#475569] rounded-xl p-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button 
              onClick={() => {
                // Reset the data fetched ref and try again
          ...
          <div className="flex overflow-x-auto md:overflow-visible px-4 py-2">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                activeTab === 'dashboard' ? 'bg-[#334155] text-white' : 'text-[#94A3B8] hover:bg-[#334155] hover:text-white'
              }`}
            >
              Dashboard
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                activeTab === 'users' ? 'bg-[#334155] text-white' : 'text-[#94A3B8] hover:bg-[#334155] hover:text-white'
              }`}
            >
              Users
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                activeTab === 'stations' ? 'bg-[#334155] text-white' : 'text-[#94A3B8] hover:bg-[#334155] hover:text-white'
              }`}
            >
              Stations
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                activeTab === 'sessions' ? 'bg-[#334155] text-white' : 'text-[#94A3B8] hover:bg-[#334155] hover:text-white'
              }`}
            >
              Sessions
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                activeTab === 'reports' ? 'bg-[#334155] text-white' : 'text-[#94A3B8] hover:bg-[#334155] hover:text-white'
              }`}
            >
              Reports
            </button>
                    ...
                    <div className="w-full">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <Card className="bg-[#1E293B]/50 border border-[#475569] rounded-xl p-4 md:p-6">
                          ...
                          <div className="space-y-3 md:space-y-4">
                            {sessionsData.slice(0, 4).map((sessionItem: SessionData) => (
                  ...
                  <Card className="bg-[#1E293B]/50 border border-[#475569] rounded-xl p-4 md:p-6">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody>
                          {sessionsData.map((sessionItem: SessionData) => (
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mt-4 md:mt-6">
                      <p className="text-[#94A3B8] text-xs md:text-sm mb-3 md:mb-0">Showing 1 to {sessionsData.length} of {sessionsData.length} results</p>
                      <div className="flex space-x-2">
                        <Button variant="outline" size="sm" disabled className="text-xs md:text-sm">Previous</Button>
                        <Button variant="outline" size="sm" className="text-xs md:text-sm">Next</Button>
                      </div>
