...
export const JourneyImpactStats: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl p-6 shadow-lg border border-[#475569]/50 bg-[#1E293B]/50 backdrop-blur-sm">
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            title="Refresh stats"
          >
            <svg className={`w-6 h-6 ${loading ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="w-3 h-3 rounded-full bg-blue-400 shadow-[0_0_8px_2px_rgba(96,165,250,0.5)]"></div>
              </div>
              ...
              <div className="font-medium text-[#F1F5F9] mb-2 text-sm">{stat.name}</div>
